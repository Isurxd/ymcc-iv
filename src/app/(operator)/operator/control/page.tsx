      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <Card className="bg-white border-4 border-foreground shadow-brutal-lg rounded-none h-full">
           <CardHeader className="bg-primary border-b-4 border-foreground p-6">
            <CardTitle className="text-3xl font-heading italic uppercase text-white">GLOBAL TIMER ENGINE</CardTitle>
          </CardHeader>
          <CardContent className="p-10 flex flex-col items-center justify-center text-center space-y-8">
             <div className="bg-zinc-100 border-4 border-foreground w-full py-12 shadow-[inset_8px_8px_0_0_rgba(0,0,0,0.05)]">
               <span className="text-8xl font-heading text-foreground drop-shadow-[4px_4px_0_#001F3F] [-webkit-text-stroke:1px_#001F3F]">
             ...
             <div className="flex gap-6 w-full">
               <Button 
                ...
                className="flex-1 h-20 text-2xl font-heading uppercase italic tracking-widest bg-accent hover:bg-orange-500 text-foreground border-4 border-foreground shadow-[8px_8px_0_0_var(--color-foreground)] hover:-translate-y-1 transition-all rounded-none gap-3 disabled:opacity-50 disabled:shadow-none disabled:translate-y-0"
               >
               ...
               <Button 
                ...
                disabled={examState !== 'RUNNING'}
                className="flex-1 h-20 text-2xl font-heading uppercase italic tracking-widest bg-zinc-200 hover:bg-zinc-300 text-foreground border-4 border-foreground shadow-[8px_8px_0_0_var(--color-foreground)] hover:-translate-y-1 transition-all rounded-none gap-3 disabled:opacity-50 disabled:shadow-none disabled:translate-y-0"
               >
        ...
        <Card className="bg-white border-4 border-foreground shadow-brutal-lg rounded-none">
           <CardHeader className="bg-[#001F3F] border-b-4 border-foreground p-6">
            <CardTitle className="text-3xl font-heading italic uppercase text-white flex items-center justify-between">
